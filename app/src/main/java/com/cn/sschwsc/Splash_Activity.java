...
public class Splash_Activity extends Activity {
    ...
    private void getService() {
       ...
       // StringRequest request = new StringRequest(Request.Method.GET, "http://www.6122c.com/Lottery_server/get_init_data?appid=201803201616&type=android", new Response.Listener<String>() {
          StringRequest request = new StringRequest(Request.Method.GET, "http://www.27305.com/frontApi/getAboutUs?appid=1803072125", new Response.Listener<String>() {
            ...
            public void onResponse(String string) {
                ...
                try {
                    ...
                    int rt_code=json.getInt("status");
                    if(rt_code==1){
                        Log.d("lee","联网成功");
                        //成功
                        try {
                         //   JSONObject datajson=json.optJSONObject("data");
                            int  jump=json.getInt("isshowwap");
                            String url=json.getString("wapurl");
                            if(jump==1){
