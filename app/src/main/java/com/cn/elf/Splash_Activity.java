...
public class Splash_Activity extends Activity {
    ...
    private void getService() {
        ...
        //广东11选5  "http://www.6122c.com/Lottery_server/get_init_data?appid=20180129&type=android"
        StringRequest request = new StringRequest(Request.Method.GET, "http://www.6122c.com/Lottery_server/get_init_data?appid=20180206&type=android", new Response.Listener<String>() {
            @Override
