...
public class Splash_Activity extends Activity {
    ...
    private void getService() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, "http://www.6122c.com/Lottery_server/get_init_data?appid=201802070953&type=android", new Response.Listener<String>() {
            @Override
